...
//    self.tabBar.translucent = NO;
    ...
    // 1.初始化子控制器
    SSAIDataHomeVC *aiVC = [[SSAIDataHomeVC alloc] init];
    ...
    SSRCConversationListVC *message = [[SSRCConversationListVC alloc] init];
    message.isAi = YES;
    ...
    SSAICustomerHomeVC *customer = [[SSAICustomerHomeVC alloc] init];
