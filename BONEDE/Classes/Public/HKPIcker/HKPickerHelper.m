...
//    [self addMultimediaActionWithChooseImage:YES];
    SSImagePickerVC *imagePickerVc = [[SSImagePickerVC alloc] initWithMaxImagesCount:9 columnNumber:3 delegate:self pushPhotoPickerVc:YES];
...
//- (void)showPhotoWIthSuperVC:(UIViewController *)superVC{
//    SSImagePickerVC *imagePickerVc = [[SSImagePickerVC alloc] initWithMaxImagesCount:1 columnNumber:1 delegate:self pushPhotoPickerVc:YES];
