...
- (void)dealJPushActionWithDic:(NSDictionary *)userInfo{
    ...
    if([dict count]){
        ...
        if([strType isEqualToString:@"1"] || [strType isEqualToString:@"2"]|| [strType isEqualToString:@"3"]|| [strType isEqualToString:@"7"]|| [strType isEqualToString:@"13"]|| [strType isEqualToString:@"14"]){
            //1跳商品  2跳订单详情 3更新 4B店铺访问 5C店铺访问 7预约管理 8投票 13 14员工有任务
